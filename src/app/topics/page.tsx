...
export default function Topics() {
  ...
  return (
    <main className="flex flex-col w-full items-center justify-between mt-16 mb-8">
      <div className="text-2xl">精選專題</div>
      <Slider slides={featuredComponents} />
      <div className="text-2xl">所有專題</div>
      <div className="mt-8 mb-4 grid text-center w-4/5 lg:grid-cols-4 lg:text-left gap-8">{topicComponents}</div>
    </main>
  )
}
